...
<div
    ...
    <main class="flex max-w-[335px] w-full lg:max-w-4xl flex-col lg:flex-row">
        <div
            ...
            <div class="relative w-full lg:w-1/2">
                <img src="{{ Vite::asset('public/images/man-plan-work-growth-workplace.webp') }}"
            ...
            <div class="dark:text-[#EDEDEC] w-full lg:w-1/2 leading-normal">
                <h1 class="mt-1 font-semibold text-lg--line-height">Control Financiero</h1>
                <div class="mt-2">
                    <p class="font-sans text-sm--line-height text-[#706f6c] dark:text-[#A1A09A]">
                        Lleva un registro claro de tus ingresos, gastos y ahorros.
                    </p>
                    <p class="font-sans text-sm--line-height text-[#706f6c] dark:text-[#A1A09A]">
                        Organiza tu economía personal y alcanza tus metas financieras con facilidad.
                    </p>
                </div>
            </div>
        </div>
