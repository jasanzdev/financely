                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        <div class="flex items-center justify-end gap-2 sm:gap-3 w-full">
                            <button wire:click.prevent="changeStatus('{{ $obligation->id }}')"
                                    ...
                                    class="py-2 px-3 sm:px-4 sm:py-2 text-xs border hover:bg-neutral-200 hover:dark:bg-neutral-700 text-neutral-950 dark:text-white shadow-lg rounded-lg cursor-pointer transition-colors duration-200
                                    {{ $obligation->is_active ? 'border-danger bg-danger' : 'border-success bg-success' }}"
                                    type="button"
